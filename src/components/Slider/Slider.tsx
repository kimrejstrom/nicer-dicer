      ...
      <div className="slides hidden-scroll">
        {slides.map((slide, index) => (
          ...
          >
            ...
            {/* Next / Previous */}
            <a
              className="absolute right-0 h-8 w-8 -mt-4 bg-white opacity-25 rounded-full text-gray-900 text-2xl leading-8"
              style={{ top: '50%' }}
            ...
            <a
              className="absolute left-0 h-8 w-8 -mt-4 bg-white opacity-25 rounded-full text-gray-900 text-2xl leading-8"
              style={{ top: '50%' }}
              href={`#slide-${(index - (1 % slides.length) + slides.length) %
                slides.length}`}
            >
