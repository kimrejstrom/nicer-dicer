...
Nicer Dicer uses the [`dice-typescript`](https://github.com/trwolfe13/dice-typescript) package as it's dice engine. Dice-Typescript is based on the Roll20 dice specification that can be found on the [Roll20 Wiki](https://wiki.roll20.net/Dice_Reference).
